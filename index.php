			...
			<nav class="main_nav_container">
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="main_nav_item"><a href="#">activities</a></li>
						<li class="main_nav_item"><a href="modules.php">modules</a></li>
	...
	<div class="about page_section">
		<div class="container">
			...
			<div class="row">
				<!-- Popular Course Item -->
				<div class="col-lg-6">
					<p class="about_text"> Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. 	Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500, quand un imprimeur anonyme assembla ensemble 		des morceaux de texte pour réaliser un livre spécimen de polices de texte. Il n'a pas fait que survivre cinq siècles, mais s'est 	aussi adapté à la bureautique informatique, sans que son contenu n'en soit modifié. Il a été popularisé dans les années 1960 grâce 		à la vente de feuilles Letraset contenant des passages du Lorem Ipsum, et, plus récemment, par son inclusion dans des 				applications de mise en page de texte, comme Aldus PageMaker.
					</p>
				</div>
			...
			<div class="row course_boxes">
				...
				<!-- <div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.php">Beginners guide to php</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
