...
if ($dbh) {
	...
	if (isset($_GET['id'])) {
		...
		$id = $_GET['id'];
		$Query = "SELECT N.id,titleNews,descriptionNews,contentNews,imageNews,dateNews,nbCommentsNews,nameTeach FROM teacher T ,news N WHERE T.numTeach = N.idAuthorNews and N.id =$id ";
		$sth = $dbh->query($Query);
								...
								foreach ($news as $new) { ?>
									...
									<div class="news_post">
										<div class="news_post_image">
											<img src="<?php echo $new['imageNews']; ?>" alt="https://unsplash.com/@dsmacinnes">
										</div>
										<div class="news_post_top d-flex flex-column flex-sm-row">
											...
											<div class="news_post_title_container">
												...
												<div class="news_post_meta">
													<span class="news_post_author"><a href="#">By <?php echo $new['nameTeach']; ?></a></span>
													<span>|</span>
