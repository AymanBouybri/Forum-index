...
if ($dbh) {
	...
	$Query = "SELECT N.id,titleNews,descriptionNews,contentNews,imageNews,dateNews,nbCommentsNews,nameTeach FROM teacher T ,news N WHERE T.numTeach = N.idAuthorNews Limit 3 ";
	$sth = $dbh->query($Query);
